...
# Newly update
The code of preprocessing the raw data of SDD and ETH-UCY is available in `./utils/`: just run
`./utils/generate_dataset_SDD.py` or `./utils/generate_dataset_ETHUCY.py`.
